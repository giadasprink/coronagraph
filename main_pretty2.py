...
snr_plot.background_fill_alpha = 0.0
...
snr_plot.title.text_color='black' 
snr_plot.yaxis.axis_label_text_color = 'black' 
snr_plot.xaxis.axis_label_text_color = 'black' 
snr_plot.yaxis.major_label_text_color = 'black' 
snr_plot.xaxis.major_label_text_color = 'black'
snr_plot.xgrid.grid_line_color = None
snr_plot.ygrid.grid_line_color = None

exp_plot.background_fill_color = "white"
exp_plot.background_fill_alpha = 0.0
...
exp_plot.title.text_color='black' 
exp_plot.yaxis.axis_label_text_color = 'black' 
exp_plot.xaxis.axis_label_text_color = 'black' 
exp_plot.yaxis.major_label_text_color = 'black' 
exp_plot.xaxis.major_label_text_color = 'black'
exp_plot.xgrid.grid_line_color = None
exp_plot.ygrid.grid_line_color = None

counts_plot.background_fill_color = "white"
counts_plot.background_fill_alpha = 0.0
...
counts_plot.title.text_color='black' 
counts_plot.yaxis.axis_label_text_color = 'black' 
counts_plot.xaxis.axis_label_text_color = 'black' 
counts_plot.yaxis.major_label_text_color = 'black' 
counts_plot.xaxis.major_label_text_color = 'black' 
counts_plot.xgrid.grid_line_color = None
counts_plot.ygrid.grid_line_color = None

snr_plot.line('lam','cratio',source=compare,line_width=4.0, color="#A4BCC5", alpha=0.) #F59A0A
snr_plot.line('lam','cratio',source=planet,line_width=4.0, color="#FFCC9D", alpha=1.) #A4BCC5
snr_plot.circle('lam', 'spec', source=planet, fill_color='#FFAD41', line_color='#FFAD41', size=8, name='snr_plot_circle_hover') 
snr_plot.segment('lam', 'downerr', 'lam', 'uperr', source=planet, line_width=1, line_color='#FFE0B0', line_alpha=0.5)
...
# Read-in new spectrum file only if changed
    ...
    if template.value != lasttemplate:
       ...
       if template.value =='Sun Moderate CH4':
          fn = 'HAZE_msun13_0.0Ga_3.400E+11ch4_1.000bar_1.00E-02o2_0.70fscaleSTCUM_toa.rad'
          fn1 = 'msun13_0.0Ga_3.400E+11ch4_1.000bar_1.00E-02o2_0.70fscale_toa.rad'
          fn = os.path.join(relpath, fn)
          fn1 = os.path.join(relpath, fn1)
          model = np.loadtxt(fn, skiprows=1)
          lamhr_ = model[:,0]
          ...
          Rs_    = 1.      # star radius in solar radii
          solhr_ =  cg.noise_routines.Fstar(lamhr_, Teff_, Rs_, semimajor.value, AU=True)
          planet_label_ = ['Synthetic spectrum generated by G. Arney']
          
       if template.value =='K6V Moderate CH4':
          fn = 'HAZE_msun25_0.0Ga_3.400E+11ch4_1.000bar_1.00E-02o2_0.70fscaleSTCUM_toa.rad'
          fn1 = 'msun25_0.0Ga_3.400E+11ch4_1.000bar_1.00E-02o2_0.70fscale_toa.rad'
          fn = os.path.join(relpath, fn)
          fn1 = os.path.join(relpath, fn1)
          model = np.loadtxt(fn, skiprows=1)
          lamhr_ = model[:,0]
          ...
          lamhr_ = lamhr_[::-1]
          Ahr_ = Ahr_[::-1]
          semimajor.value = 0.42
          radius.value = 1.
          Teff_  = 4515.   # Sun-like Teff (K)
          Rs_    = 0.533      # star radius in solar radii
          solhr_ =  cg.noise_routines.Fstar(lamhr_, Teff_, Rs_, semimajor.value, AU=True)
          planet_label_ = ['Synthetic spectrum generated by G. Arney']        


       if template.value =='Sun High CH4':
          fn = 'HAZE_msun13_0.0Ga_7.000E+11ch4_1.000bar_1.00E-01o2_0.70fscaleSTCUM_toa.rad'
          fn1 = 'msun13_0.0Ga_7.000E+11ch4_1.000bar_1.00E-01o2_0.70fscale_toa.rad'
          fn = os.path.join(relpath, fn)
          fn1 = os.path.join(relpath, fn1)
          model = np.loadtxt(fn, skiprows=1)
          lamhr_ = model[:,0]
       ...
       if template.value =='K6V High CH4':
          fn = 'HAZE_msun25_0.0Ga_7.000E+11ch4_1.000bar_1.00E-01o2_0.70fscaleSTCUM_toa.rad'

          fn1 = 'msun25_0.0Ga_7.000E+11ch4_1.000bar_1.00E-01o2_0.70fscale_toa.rad'
          fn = os.path.join(relpath, fn)
          fn1 = os.path.join(relpath, fn1)
          model = np.loadtxt(fn, skiprows=1)
          lamhr_ = model[:,0]
    ...
    if comparison.value != lastcomparison or teststar:
      ...
      if comparison.value =='Sun Moderate CH4':
          fn = 'HAZE_msun13_0.0Ga_3.400E+11ch4_1.000bar_1.00E-02o2_0.70fscaleSTCUM_toa.rad'
          fn1 = 'msun13_0.0Ga_3.400E+11ch4_1.000bar_1.00E-02o2_0.70fscale_toa.rad'
          fn = os.path.join(relpath, fn)
          fn1 = os.path.join(relpath, fn1)
      ...
      if comparison.value =='K6V Moderate CH4':
          fn = 'HAZE_msun25_0.0Ga_3.400E+11ch4_1.000bar_1.00E-02o2_0.70fscaleSTCUM_toa.rad'
          fn1 = 'msun25_0.0Ga_3.400E+11ch4_1.000bar_1.00E-02o2_0.70fscale_toa.rad'
          fn = os.path.join(relpath, fn)
          fn1 = os.path.join(relpath, fn1)
          ...
          semimajor_c = 0.42
          radius_c = 1.
          Teff_c  = 4515.   # Sun-like Teff (K)
          Rs_c    = 0.533      # star radius in solar radii
          solhr_c =  cg.noise_routines.Fstar(lamhr_c, Teff_c, Rs_c, semimajor_c, AU=True)
          planet_label_c = ['Synthetic spectrum generated by G. Arney']      


      if comparison.value =='Sun High CH4':
          fn = 'HAZE_msun13_0.0Ga_7.000E+11ch4_1.000bar_1.00E-01o2_0.70fscaleSTCUM_toa.rad'
          fn1 = 'msun13_0.0Ga_7.000E+11ch4_1.000bar_1.00E-01o2_0.70fscale_toa.rad'
          fn = os.path.join(relpath, fn)
          fn1 = os.path.join(relpath, fn1)
      ...
      if comparison.value =='K6V High CH4':
          fn = 'HAZE_msun25_0.0Ga_7.000E+11ch4_1.000bar_1.00E-01o2_0.70fscaleSTCUM_toa.rad'
...
exozodi.callback = CustomJS(args=dict(source=source), code="""
    source.data = { value: [cb_obj.value] }
""")
diameter  = Slider(title="Encircled Mirror Diameter (meters)", value = 12.2, start=0.5, end=50., step=0.1, callback_policy='mouseup') 
...
resolution.callback = CustomJS(args=dict(source=source), code="""
    source.data = { value: [cb_obj.value] }
""")
resolution_UV  = Slider(title="Telescope UV Resolution (R)", value = 10.0, start=4.0, end=300., step=1., callback_policy='mouseup') 
resolution_UV.callback = CustomJS(args=dict(source=source), code="""
    source.data = { value: [cb_obj.value] }
""")
resolution_NIR  = Slider(title="Telescope NIR Resolution (R)", value = 100.0, start=4.0, end=1000., step=1., callback_policy='mouseup') 
...
outer.callback = CustomJS(args=dict(source=source), code="""
    source.data = { value: [cb_obj.value] }
""")
darkcurrent_uv  = Slider(title="UV Dark Current (counts/s)", value = 1e-4, start=1e-5, end=1e-3, step=1e-5, callback_policy='mouseup') 
darkcurrent_uv.callback = CustomJS(args=dict(source=source), code="""
    source.data = { value: [cb_obj.value] }
""")
darkcurrent_vis  = Slider(title="VIS Dark Current (counts/s)", value = 1e-4, start=1e-5, end=1e-3, step=1e-5, callback_policy='mouseup') 
darkcurrent_vis.callback = CustomJS(args=dict(source=source), code="""
    source.data = { value: [cb_obj.value] }
""")
darkcurrent_nir  = Slider(title="NIR Dark Current (counts/s)", value = 1e-3, start=1e-5, end=1e-3, step=1e-5, callback_policy='mouseup') 
...
<br><br>
The "Telescope" tab controls whether to simulate specific observatory architecture,  encircled mirror diameter,  telescope temperature, the number of thermal surfaces, whether to show the currently considered LUVOIR bandpasses, aperture throughput, and the contrast.
<br><Br>
