...
snr_plot.background_fill_alpha = 0.4
...
exp_plot.background_fill_alpha = 0.4
...
counts_plot.background_fill_alpha = 0.4
...
outer.callback = CustomJS(args=dict(source=source), code="""
    source.data = { value: [cb_obj.value] }
""")
darkcurrent_uv  = Slider(title="UV Dark Current (counts/s)", value = 1e-4, start=1e-6, end=1e-3, step=1e-5, callback_policy='mouseup') 
darkcurrent_uv.callback = CustomJS(args=dict(source=source), code="""
    source.data = { value: [cb_obj.value] }
""")
darkcurrent_vis  = Slider(title="VIS Dark Current (counts/s)", value = 1e-4, start=1e-6, end=1e-3, step=1e-5, callback_policy='mouseup') 
darkcurrent_vis.callback = CustomJS(args=dict(source=source), code="""
    source.data = { value: [cb_obj.value] }
""")
darkcurrent_nir  = Slider(title="NIR Dark Current (counts/s)", value = 1e-3, start=1e-6, end=1e-3, step=1e-5, callback_policy='mouseup') 
darkcurrent_nir.callback = CustomJS(args=dict(source=source), code="""
    source.data = { value: [cb_obj.value] }
""")
readnoise_uv  = Slider(title="UV Read noise (counts/pixel)", value = 0, start=0, end=10, step=0.01, callback_policy='mouseup') 
readnoise_uv.callback = CustomJS(args=dict(source=source), code="""
    source.data = { value: [cb_obj.value] }
""")
readnoise_vis  = Slider(title="VIS Read noise (counts/pixel)", value = 0, start=0, end=10, step=0.01, callback_policy='mouseup') 
readnoise_vis.callback = CustomJS(args=dict(source=source), code="""
    source.data = { value: [cb_obj.value] }
""")
readnoise_nir  = Slider(title="NIR Read noise (counts/pixel)", value = 0.018, start=0, end=10, step=0.01, callback_policy='mouseup') 
